 ...
 * 1) Set a break point in JavaPlaySubProjectGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class JavaPlaySubProjectGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("java-play-sub-project") // use this codegen library
              ...
              .setOutputDir("out/java-play-sub-project"); // output directory
